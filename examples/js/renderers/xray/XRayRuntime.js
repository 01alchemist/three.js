 ...
 *
 */
var INSIDE_WORKER = false;
var XRAY_SUPPORT = false;
...
if (typeof SharedArrayBuffer === "undefined") {
    console.warn("XRay renderer is not suported in your browser");
} else {
    (function Initialize_XRayRuntime(context) {
